        ...
        <div className="container footer-grid">
          ...
          <div className="footer-col footer-safety">
            ...
            <div className="safety-links">
              <a href="https://www.spillemyndigheden.dk/" target="_blank" rel="noopener noreferrer" className="safety-link">
              ...
              <a href="https://www.rofus.nu" target="_blank" rel="noopener noreferrer" className="safety-link">
              ...
              <a href="https://www.stopspillet.dk/" target="_blank" rel="noopener noreferrer" className="safety-link">
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <p className="footer-legal">
            NordicCasinoList.com er et uafhængigt affiliatewebsted. Vi modtager provision fra casinoer, når du klikker på vores links, men dette påvirker ikke vores redaktionelle vurderinger. Alle casinoer på dette site er licenseret af <a href="https://www.spillemyndigheden.dk/" target="_blank" rel="noopener noreferrer">Spillemyndigheden</a>. Husk at spille ansvarligt. Gambling kan være vanedannende – søg hjælp hos <a href="https://www.stopspillet.dk/" target="_blank" rel="noopener noreferrer">StopSpillet</a> eller <a href="https://www.rofus.nu" target="_blank" rel="noopener noreferrer">ROFUS</a> om nødvendigt. Kun for +18.
          </p>
